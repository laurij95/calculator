...
class _SimpleCalculatorState extends State<SimpleCalculator> {
  ...
  Widget buildTopLayer(String buttonText, double buttonHeight, Color buttoncolor, Color textcolor){
    return Container(
        height: MediaQuery.of(context).size.height*0.1*buttonHeight,
        color: buttoncolor,
        child: FlatButton(
              ...
              Container(
                ...
                child: Table(
                  children: [
                    TableRow(
                        children: [
                          buildTopLayer("", 1, Colors.white10, Colors.black12),
                          buildTopLayer("", 1, Colors.white10, Colors.black12),
                          buildTopLayer("", 1, Colors.white10, Colors.black12),
                          buildTopLayer("⌫", 1, Colors.white10, Colors.blue),
                        ]
                    )
                  ],
                ),
              ...
              Container(
                ...
                child: Table(
                  children: [
                    TableRow(
                        children: [
                          buildButton("C", 1, Colors.white, Colors.orangeAccent),
